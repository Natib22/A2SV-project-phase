    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='flex gap-2'>
        ...
        {job.about.categories.map((category , index) => (
          index % 2 == 0 ? <p className="flex items-center justify-center bg-[#56CDAD1A] text-xs text-[#56CDAD] rounded-2xl h-[31px] min-w-20 w-auto  py-1 px-3">{category}</p> 
          : <p className="flex items-center justify-center bg-[#EB85331A] text-xs text-[#FFB836] rounded-2xl h-[31px] min-w-20 w-auto  py-1 px-3">{category}</p>
        ))}
    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='flex gap-2 flex-wrap'>
        {job.about.required_skills.map((skill) => (
            <p className="flex items-center justtify-center font-epilogue text-base bg-[#F8F8FD]  text-[#4640DE]  h-[37px] min-w-20 w-auto  py-1 px-3">{skill}</p>
        )) }
