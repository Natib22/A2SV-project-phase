...
function deleteButton(myDiv: Element) {
  if (container) {
...
function completeButton(myDiv: Element, taskTitle: HTMLHeadingElement | null, mySpan: HTMLSpanElement | null, complete: Element , edit: Element) {
  if (mySpan) {
...
function editButton(taskTitle: HTMLHeadingElement | null, mySpan: HTMLSpanElement | null) {
    if (taskTitle){
